...
function (_React$Component) {
  ...
  function Blog() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = Blog.__proto__ || Object.getPrototypeOf(Blog)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      ...
      value: function value() {
        var blogCards = _this.props.json.item.map(function (item) {
  ...
  _createClass(Blog, [{
    ...
    value: function componentDidMount() {// console.log(json)
    }
  }, {
    key: "render",
    value: function render() {
      ...
      }, this.props.json ? this.renderBlogCards() : null));
    }
  }]);
...
//# sourceMappingURL=7.fe3babb614a11a130803.hot-update.js.map